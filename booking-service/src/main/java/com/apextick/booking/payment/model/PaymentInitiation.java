...
public record PaymentInitiation(
    ...
    public static PaymentInitiation requiresAction(String providerRef, String clientSecret) {
        return new PaymentInitiation(PaymentOutcome.REQUIRES_ACTION, providerRef, clientSecret, null,
    ...
    public static PaymentInitiation failed(String code, String message) {
        return new PaymentInitiation(PaymentOutcome.FAILED, null, null, null, null, null, code, message, null);
    }
}
